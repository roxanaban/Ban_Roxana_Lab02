...
namespace Ban_Roxana_Lab2.Models
{
    public class Member
    {
        ...
        [RegularExpression(@"^0[0-9]{2}[-. ]?([0-9]{3})[-. ]?([0-9]{3})$", ErrorMessage = "Telefonul trebuie să înceapă cu 0 și să fie de forma '0722-123-123' sau '0722.123.123' sau '0722 123 123'")]
